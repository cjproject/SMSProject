...
public class ProjectUtil
{
	...
	public static void setAlertInfoPropFromCBO(CEOAlertInfo alertInfo, CustomBusinessObject alertCBO) {
		...
		alertInfo.setBeginDate(ProjectUtil.getBOCalendarFieldValue(alertCBO, "BeginDate"));
		alertInfo.setEndDate(ProjectUtil.getBOCalendarFieldValue(alertCBO, "EndDate"));
		alertInfo.setUserName(ProjectUtil.getBOStringFieldValue(alertCBO, "UserName"));
		alertInfo.setPassword(ProjectUtil.getBOStringFieldValue(alertCBO, "Password"));
		alertInfo.setSchedule(ProjectUtil.getBOBooleanFieldValue(alertCBO, "Schedule"));
	...
	{
		if(ProjectUtil.getBOFieldValue(obj, fieldName) instanceof Boolean)
			return ((Boolean)ProjectUtil.getBOFieldValue(obj, fieldName)).booleanValue() == true ? 1 : 0;
		else
			return ProjectUtil.getBOIntFieldValue(obj, fieldName); 
	}
